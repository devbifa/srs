...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Instructor_productivity_hours extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/instructor_productivity_hours/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/instructor_productivity_hours');
		}
