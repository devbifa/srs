...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Flight_intructor_productivity_hours extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/flight_intructor_productivity_hours/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/flight_intructor_productivity_hours');
		}
