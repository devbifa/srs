...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Student_payment_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/student_payment_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/student_payment_report');
		}
