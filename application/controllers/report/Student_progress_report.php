...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Student_progress_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/student_progress_report/detail',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/student_progress_report');
		}
...

		{
			...
			$this->template->load('template/template','dashboard/daily_attendance/add-daily_ftd_schedule',$data);
