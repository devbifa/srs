...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ground_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/ground_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/ground_report');
		}
...

		{
			...
			$this->template->load('template/template','report/daily_attendance/add-daily_ftd_schedule',$data);
