...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class My_record extends MY_Controller {
...

		{
			...
			if($_SESSION['role']=='4'){
				$this->template->load('template/template','menu/my_record/student_hours/all',$data);
			}else{
				$this->template->load('template/template','menu/my_record/instructor_hours/all',$data);
			}
...

		{
			...
			if($_SESSION['role']=='4'){
				$this->template->load('template/template','menu/my_record/student_hours/progress',$data);
			}else{
				$this->template->load('template/template','menu/my_record/instructor-all',$data);
			}
...

		{
			...
			if($_SESSION['role']=='4'){
				$this->template->load('template/template','menu/my_record/student_hours/detail',$data);
			}else{
				$this->template->load('template/template','menu/my_record/instructor-all',$data);
			}
		...
		function filter(){
			...
			redirect(base_url().'menu/my_record');
		}
