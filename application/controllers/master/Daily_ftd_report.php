...
// $this->form_validation->set_rules('dt[remark_report]', '<strong>Remark</strong>', 'required');
...

		{
			...
			$data['daily_ftd_schedule'] = $this->mymodel->selectDataone('daily_ftd_schedule',array('id'=>$id));

			$data['file'] = $data['daily_ftd_schedule']['file_report'];
		...
		{	
			...
			if (!empty($_FILES['file']['name'])){
				...
				$dat = $this->mymodel->selectDataOne('syllabus_mission',array('code'=>$dt['mission'],'type_of_training'=>'FTD'));
				$mission = $dat;
