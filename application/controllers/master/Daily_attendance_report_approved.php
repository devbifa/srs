...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Daily_attendance_report_approved extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','master/daily_attendance_report_approved/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'master/daily_attendance_report_approved');
		}
