...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Safety_performance extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','record/safety_performance/all',$data);

		}

		function excel(){
			$data = array();
			$this->load->view("record/safety_performance/excel");
		}
		...
		function filter(){
			...
			redirect(base_url().'record/safety_performance');
		}
