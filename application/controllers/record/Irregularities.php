...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Irregularities extends MY_Controller {
...

		{
			...
			$data['page_name'] = "Irregularities";

			
			
			$this->template->load('template/template','record/irregularities/all',$data);

		}

		function excel(){
			$data = array();
			$this->load->view("record/irregularities/excel");
		}
		...
		function filter(){
			...
			redirect(base_url().'record/irregularities');
		}
