...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Student_hours extends MY_Controller {
...

		{
			...
			$data['page_name'] = "Student_hours";

			
		// print_r($data['data']);die;
			$this->template->load('template/template','record/student_hours/all',$data);
...

		{
			...
			$this->template->load('template/template','record/student_hours/student',$data);
...

		{
			...
			$this->template->load('template/template','record/student_hours/student_course',$data);
...

		{
			...
			$this->template->load('template/template','record/student_hours/student_detail',$data);

		}

		public function student_rev($id)

		{

			$data['page_name'] = "Student_hours";

			$this->template->load('template/template','record/student_hours/student_rev',$data);
		...
		function filter(){
			...
			redirect(base_url().'record/student_hours');
		}
