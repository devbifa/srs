...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Flight_schedule extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','dashboard/flight_schedule/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'dashboard/flight_schedule');
		}
