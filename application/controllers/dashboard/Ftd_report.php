...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ftd_report extends MY_Controller {
		...
		// print_r($data['data']);die;
			$this->template->load('template/template','dashboard/ftd_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'dashboard/ftd_report');
		}
...
$this->form_validation->set_rules('dt[remark]', '<strong>Remark</strong>', 'required');
...

		{
	        ...
	        $this->datatables->select('a.id,a.date,a.ftd_model,a.eet_utc,a.etd_utc,a.eta,a.remark,a.status,f.nick_name as pic,g.nick_name as 2nd,d.course_code as course,c.batch,CONCAT(e.subject_mission,' - ',e.name) as mission,e.name as mission_name,');
