...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Aircraft_hours extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','record/aircraft_hours/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'record/aircraft_hours');
		}
