...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Flight_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','dashboard/flight_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'dashboard/flight_report');
		}
