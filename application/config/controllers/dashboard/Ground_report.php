...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ground_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','dashboard/ground_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'dashboard/ground_report');
		}
