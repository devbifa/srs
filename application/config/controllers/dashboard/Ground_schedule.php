...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ground_schedule extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','dashboard/ground_schedule/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'dashboard/ground_schedule');
		}
