...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Daily_ftd_report_approved extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','master/daily_ftd_report_approved/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'master/daily_ftd_report_approved');
		}
