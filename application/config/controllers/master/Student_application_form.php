...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Student_application_form extends MY_Controller {
		...
		function submit(){
			$this->db->query("UPDATE student_application_form SET visibility = '1' WHERE visibility = '0'");
...

		{
			...
			FROM user a
			WHERE a.instructor_status != '1' AND a.visibility = '0' AND a.full_name != ''");
...
$this->form_validation->set_rules('dt[batch]', '<strong>Batch</strong>', 'required');
...

		{
	        ...
	        $this->datatables->select('a.id, DATE_FORMAT(a.registration_date,"%d %b %Y") as registration_date,DATE_FORMAT(a.date_of_birth,"%d %b %Y") as date_of_birth,a.application_number,a.full_name, a.nick_name, a.place_of_birth, a.gender,a.batch,a.student_status as status, a.remark');
