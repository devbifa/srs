...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Daily_student_attendance_report extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','master/daily_student_attendance_report/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'master/daily_student_attendance_report');
		}
