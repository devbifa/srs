...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ftd_intructor_productivity_hours extends MY_Controller {
...

		{
			...
			$this->template->load('template/template','report/ftd_intructor_productivity_hours/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/ftd_intructor_productivity_hours');
		}
