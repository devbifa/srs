...
<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
	...
	class Ground_intructor_productivity_hours extends MY_Controller {
...

		{
			...
			$data['page_name'] = "flight_intructor_productivity_hours";

			$this->template->load('template/template','report/ground_intructor_productivity_hours/all',$data);
		...
		function filter(){
			...
			redirect(base_url().'report/ground_intructor_productivity_hours');
		}
