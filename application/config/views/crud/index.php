                     ...
                     <tbody>
                      ...
                      <?php 
                       ...
                       <tr>
                        ...
                        <?php if($st['COLUMN_KEY']!="PRI" AND $st['COLUMN_NAME']!="status" AND $st['COLUMN_NAME']!="created_at" AND $st['COLUMN_NAME']!="updated_at" AND $st['COLUMN_NAME']!="created_by"){ ?>
                     ...
                     $li="";
                      ...
                      if (!in_array("status", $COLUMN_NAME)){
                        ...
                        if (!in_array("created_by", $COLUMN_NAME)){
                          ...
                          $li.= "<li><em>ALTER TABLE ".$name_table." ADD COLUMN created_by INT AFTER updated_at;</em></li>";
