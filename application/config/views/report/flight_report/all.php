        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <select onchange="loadtable(this.value)" id="select-status" style="width: 250px" class="form-control">
            ...
            <div class="box-body">
               ...
               <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>dashboard/flight_report/filter" method="post">
                                <div class="col-md-2">
                ...
                <?php 
                  ...
                  ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>&nbsp</label><br>
                                            <a class="btn btn-success btn-block" href="<?=base_url()?>features/print_flight_report" target="_blank"><i class="mdi mdi-printer"></i> PRINT</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
