...
<tr>
    <th colspan="20" style="font-size:12px;"><?=$date?>
    </th>
  </tr>

  <tr class="bg-success">

<th rowspan="2">NO</th><th rowspan="2">ACFT<br>REG</th><th rowspan="2">PIC</th>
<th rowspan="2">2ND</th><th rowspan="2">COURSE</th><th rowspan="2">MISSION</th>
<th rowspan="2">ROUTE</th>
<th rowspan="2">BATCH</th><th colspan="3">SCHEDULED TIME</th>
<th colspan="3">
  BLOCK TIME
</th>
<th colspan="3">
...
$total2 = array();
$total3 = array();
$array_aircraft = array();$array_duty_instructor = array();
...
foreach($data as $key=>$val){
  ...
  <tr>
    ...
    <td style="width:3%"><?=$val['remark_dmr']?></td>
  </tr>
<?php 
...
<tr>
  <td colspan="20" style="padding:0.1px;background:#000;" ></td>
</tr>
