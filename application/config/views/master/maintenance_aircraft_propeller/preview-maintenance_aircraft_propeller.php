  ...
  <div class="content-wrapper">
    ...
    <div class="form-group col-md-6">
                        : <?= $maintenance_aircraft_propeller['aircraft_reg'] ?>
                    </div>
                    </div>
                        </div>
  ...
  <div class="form-group col-md-6">
                      : <?= $maintenance_aircraft_propeller['new_serial_number'] ?>
                  </div>
                  </div>
                      </div>
  ...
  <div class="form-group col-md-6">
                      : <?= $maintenance_aircraft_propeller['old_serial_number'] ?>
                  </div>
                  </div>
                      </div>
  ...
  <div class="form-group col-md-6">
                      : <?= $maintenance_aircraft_propeller['remark'] ?>
                  </div>
                  </div>
                      </div>
