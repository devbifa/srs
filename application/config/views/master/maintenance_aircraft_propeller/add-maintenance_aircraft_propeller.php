  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/maintenance_aircraft_propeller/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  ...
                  Tambah Maintenance Aircraft Propeller
