...
<label for="form-nationality">BATCH ALLOCATION</label>
...
<table class="table table-bordered" id="mytable" style="width:100%">
                        ...
                        <tr class="bg-success">
                          ...
                          <th style="width:20px">NUM</th><th  style="width:125px;">ACTION</th><th>BATCH</th><th>REGISTRATION DATE</th><th>APPLICATION NUMBER</th><th>FULL NAME</th><th>NICK NAME</th>
                   ...
                   <th>GENDER</th>
                        ...
                        <tbody>
                            <?php foreach($mydata as $key=>$val){ ?>
                                ...
                                <td><?=$key+1?></td>
                                <td>
                                <a href="<?=base_url()?>master/student_application_form/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/student_application_form/delete_data/<?=$val['id']?>">Delete Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<a href="#!" data-toggle="modal" data-target="#modal-submit"  class="btn btn-primary pull-right">SUBMIT</a>
...
<div class="modal modal-success fade" id="modal-submit">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/student_application_form/submit">Submit Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
