  ...
  <div class="content-wrapper">
    ...
    <input disabled  disabled disabled type="hidden" name="id" value="<?= $student_application_form['id'] ?>">
...
<?php
 ...
 $curriculum = $this->mymodel->selectDataOne('curriculum', array('code'=>$batch['curriculum']));
  $id_curriculum = $curriculum['code'];
            ...
            <?php } ?>
            <input disabled  disabled disabled disabled type="file" class="form-control" id="form-file" placeholder="Insert File" name="file">
              </div>
  ...
  <div class="row">
            ...
            <div class="col-md-6">
            <div class="row">
<a class="btn btn-danger float-upload" href="#!" data-toggle="modal" data-target="#modal-reject" data-placement="top" title="REJECT APPLICANT" ><i class="mdi mdi-close"></i></a>

<a class="btn btn-success float-add" href="#!" data-toggle="modal" data-target="#modal-approve"  data-placement="top" title="APPROVE APPLICANT" ><i class="mdi mdi-check"></i></a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/student_application_form/update_file/<?=$student_application_form['id']?>/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                ...
                <input disabled  disabled type="hidden" name="type" value="student">
                <label>Attachment Type</label>
             
<input disabled  disabled autocomplete="off" readonly  type="text" class="form-control" name="dttt[id]" value="<?=$val['student_file']?>">
            </div>
<div class="form-group">
<input disabled  disabled autocomplete="off" required  type="hidden" class="form-control" name="dttt[id]" value="<?=$val['id']?>">
                              
<label>Valid Date Start</label>
                <input disabled  disabled autocomplete="off" required  type="text" class="form-control tgl" name="dttt[valid_date_start]" value="<?=$att[$val['id']]['valid_date_start']?>">
                </div>
<div class="form-group">
                <label>Valid Date Until</label>
                <input disabled  disabled autocomplete="off" required  type="text" class="form-control tgl" name="dttt[valid_date_until]" value="<?=$att[$val['id']]['valid_date_until']?>">
                </div>
<!-- <div class="form-group">
                <label>Attachment Number</label>
                <input disabled  disabled autocomplete="off" required type="text" class="form-control" name="dttt[number]" value="<?=$val['number']?>">
                </div> -->
                <div class="form-group">
                <label>Score</label>
                <input disabled  disabled autocomplete="off" required type="text" class="form-control" name="dttt[score]" value="<?=$att[$val['id']]['score']?>">
                </div>
                <div class="form-group">
                <label>Description</label>
                <input disabled  disabled autocomplete="off" required type="text" class="form-control" name="dttt[description]" value="<?=$att[$val['id']]['description']?>">
                </div>
<div class="form-group">
                <label>Attachment File</label> *empty if not updated.
                <input disabled  disabled type="file" class="form-control" name="file">
</div>
...
<div class="modal modal-danger fade" id="modal-delete-<?=$i?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/student_application_form/delete_file/<?=$student_application_form['id']?>/<?=$val['id']?>?type=student">Delete Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
