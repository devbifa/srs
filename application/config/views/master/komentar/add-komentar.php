  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Komentar/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <textarea name="dt[komentar]" class="form-control"></textarea>
