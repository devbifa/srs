  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Mission/store') ?>" id="upload-create" enctype="multipart/form-data">
                ...
                <div class="row"><div class="form-group col-md-6">
                      ...
                      <select style='width:100%' name="dt[course_code]" class="form-control select2">
                        ...
                        foreach ($course as $course_record) {
                          ...
                          echo "<option value='".$course_record['course_code']."' >".$course_record['course_name']."</option>";
...
<input type="text" class="form-control" id="form-position" placeholder="Masukan Dual Duration" name="dt[dual_duration]">
...
<input type="text" class="form-control" id="form-position" placeholder="Masukan Solo Duration" name="dt[solo_duration]">
