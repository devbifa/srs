...
<input disabled type="text" class="form-control" id="form-application_number" placeholder="Insert Employee Number" name="dt[id_number]" value="<?= $student_application_form['id_number'] ?>">
...
<div class="form-group col-md-6">
                      ...
                      <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Email" name="dt[email]" value="<?= $student_application_form['email'] ?>">
...
<input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Position" name="dt[position]" value="<?= $student_application_form['position'] ?>">
...
<input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Remark" name="dt[remark_instructor]" value="<?= $student_application_form['remark_instructor'] ?>">
...
<?php } ?>
            ...
            <?php } ?>
            <input disabled disabled disabled type="file" class="form-control" id="form-file" placeholder="Insert File" name="file">
              </div>
  ...
  <div class="row">
            ...
            <div class="col-md-6">
            <div class="row">
            <a class="btn btn-primary btn-send float-add" data-placement="top" title="EDIT INSTRUCTOR DATA"  href="<?=base_url()?>master/instructor_list/edit/<?=$student_application_form['id']?>"><i class="mdi mdi mdi-pencil"></i></a>
             
        

<a href="" class="btn btn-danger float-2" href="#!" data-toggle="modal" data-target="#modal-delete-1" data-placement="top" title="DELETE INSTRUCTOR DATA" ><i class="mdi mdi-delete"></i></a>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/instructor_list/update_file/<?=$student_application_form['id']?>/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                ...
                <input readonly autocomplete="off" required required type="text" class="form-control" name="dttt[type]" value="<?=$val['instructor_file']?>">
            </div>
<div class="form-group">
                <label>Valid Date Start</label>
                <input autocomplete="off" required required type="hidden" class="form-control" name="dttt[id]" value="<?=$val['id']?>">
                <input autocomplete="off" required required type="text" class="form-control tgl" name="dttt[valid_date_start]" value="<?=$att[$val['id']]['valid_date_start']?>">
                </div>
                <div class="form-group">
                <label>Valid Date Until</label>
                <input autocomplete="off" required required type="text" class="form-control tgl" name="dttt[valid_date_until]" value="<?=$att[$val['id']]['valid_date_until']?>">
                </div>
<!-- <div class="form-group">
                <label>Attachment Number</label>
                <input autocomplete="off" requiredrequired type="text" class="form-control" name="dttt[number]" value="<?=$val['number']?>">
                </div> -->
                <div class="form-group">
                <label>Description</label>
                <input autocomplete="off" required required type="text" class="form-control" name="dttt[description]" value="<?=$att[$val['id']]['description']?>">
                </div>
<div class="form-group">
...
<div class="modal modal-danger fade" id="modal-delete-<?=$i?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/instructor_list/delete_file/<?=$student_application_form['id']?>/<?=$key['id']?>">Delete Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<div class="modal modal-danger fade" id="modal-delete-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/instructor_list/delete/<?=$student_application_form['id']?>">
                <span style="font-weight:100">Are you sure you want to delete this instructor?</span>
