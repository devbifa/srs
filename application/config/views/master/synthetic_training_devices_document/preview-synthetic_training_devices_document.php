          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  ...
                  Edit Synthetic Training Devices Document
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-12">
                     ...
                     <label for="form-type">TYPE</label>
                      <br>
                      <?= $synthetic_training_devices_document['type'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-model">MODEL</label>
                      <br>
                      <?= $synthetic_training_devices_document['model'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-serial_number">SERIAL NUMBER</label>
                      <br>
                      <?= $synthetic_training_devices_document['serial_number'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-certificate_number">CERTIFICATE NUMBER</label>
                      <br>
                      <?= $synthetic_training_devices_document['certificate_number'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-certificate_valid">CERTIFICATE VALID</label>

                      <br>
                      <?= $synthetic_training_devices_document['certificate_valid'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-training_capabilities">TRAINING CAPABILITIES</label>
                      <br>
                      <?= $synthetic_training_devices_document['training_capabilities'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-last_input_date">LAST INPUT DATE</label>
                      <br>
                      <?= $synthetic_training_devices_document['last_input_date'] ?>
                  </div><div class="form-group col-md-12">
