      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box-header-material box-header-material-text">
                ...
                ?>
                <?=($b['curriculum'])?> > COURSE >  <?=$a['training_type']?> > EDIT
                </div>
                <div class="col-xs-2">
...
<input type="text" class="form-control" id="form-subject_mission" placeholder="Masukan Code" name="dt[code]" value="<?=$tpm_syllabus_all_course['code']?>">
                ...
                <div class="form-group col-md-3 hidden">
                      ...
                      <select style='width:100%' name="dt[type_of_training]" class="form-control select2">
                        ...
                        $type_of_training = $this->mymodel->selectWhere('training_type',array('id'=>$tpm_syllabus_all_course['type_of_training']));
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                          ...
                          window.location.href = "<?= base_url('master/curriculum/course_mission_custom/').$tpm_syllabus_all_course['curriculum'].'/'.$tpm_syllabus_all_course['type_of_training'] ?>";
