          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <label for="form-nama_motor">Nama Motor</label>

                      <input type="text" class="form-control" id="form-nama_motor" placeholder="Masukan Nama Motor" name="dt[nama_motor]" value="<?= $motor['nama_motor'] ?>">

                  </div><div class="form-group">

                      <label for="form-deskripsi_motor">Deskripsi Motor</label>

                      <textarea name="dt[deskripsi_motor]" class="form-control"><?= $motor['deskripsi_motor'] ?></textarea>
