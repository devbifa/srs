  <a href="#!" data-toggle="modal" data-target="#modal-graduate" class="btn btn-info  pull-right float-5" data-placement="top" title="GRADUATE STUDENT STATUS" ><i class="fa fa-graduation-cap" ></i></a>
              
              <a href="#!" data-toggle="modal" data-target="#modal-active" class="btn btn-success  pull-right float-active" data-placement="top" title="ACTIVATE STUDENT STATUS" ><i class="mdi mdi-checkbox-marked-circle-outline" ></i></a>
              
              <a href="#!" data-toggle="modal" data-target="#modal-hold" class="btn btn-warning  pull-right float-4"  data-placement="top" title="HOLD STUDENT STATUS" ><i class="mdi mdi-minus-circle-outline" ></i></a>
              
              <a href="#!" data-toggle="modal" data-target="#modal-terminated" class="btn btn-danger  pull-right float-terminated" data-placement="top" title="TERMINATE STUDENT STATUS" ><i class="mdi mdi-close-circle-outline" ></i></a>
          

              
              <a href="<?=base_url()?>master/student_document/edit/<?=$student_document['id']?>" class="btn btn-primary  pull-right float-add"  data-placement="top" title="EDIT STUDENT STATUS" ><i class="mdi mdi-pencil" ></i></a>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="<?=base_url()?>master/student_document/update_file/<?=$student_document['id']?>/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                  ...
                  <input disabled readonly autocomplete="off" required type="text" class="form-control" value="<?=$val['payment_status']?>">
              </div>
  <div class="form-group">
                  <label>Date</label>
                  <input disabled autocomplete="off" required type="text" class="form-control tgl" name="dttt[date]" value="<?=$att[$val['id']]['date']?>">
                  <input disabled autocomplete="off" required type="hidden" class="form-control" name="dttt[id]" value="<?=$att[$val['id']]['id']?>">
                  </div>
                  <div class="form-group">
                  <label>Due Date</label>
                  <input disabled autocomplete="off" required type="text" class="form-control tgl" name="dttt[due_date]" value="<?=$att[$val['id']]['due_date']?>">
                  </div>
                  <div class="form-group">
                  <label>Nominal Inv</label>
                  <input disabled autocomplete="off" required required type="text" class="form-control" name="dttt[nominal_inv]" value="<?=$att[$val['id']]['nominal_inv']?>">
                  </div>
                  <div class="form-group">
                  <label>Nominal Paid</label>
                  <input disabled autocomplete="off" required required type="text" class="form-control" name="dttt[nominal_paid]" value="<?=$att[$val['id']]['nominal_paid']?>">
                  </div>
                  <div class="form-group">
                  <label>Description</label>
                  <input disabled autocomplete="off" required required type="text" class="form-control" name="dttt[description]" value="<?=$att[$val['id']]['description']?>">
                  </div>
  <div class="form-group">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-outline">Upload Log</button>
                  </form>
                </div>
              </div>
              <!-- /.modal-content -->
  ...
  <label for="form-registration_date">REGISTRATION DATE</label>
    ...
    <input disabled autocomplete="off" type="text" class="form-control pull-right tgl" id="datepicker"  name="dt[registration_date]" value="<?= $student_document['registration_date'] ?>">
  ...
  <input disabled type="text" class="form-control" id="form-application_number" placeholder="Insert Application Number" name="dt[application_number]" value="<?= $student_document['application_number'] ?>">
  ...
  <div class="form-group col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert ID Number" name="dt[id_number]" value="<?= $student_document['id_number'] ?>">
  ...
  <input disabled autocomplete="off" style='width:100%' name="password" class="form-control" placeholder="Leave blank if you do not wish to change the password">
                ...
                <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Full Name" name="dt[full_name]" value="<?= $student_document['full_name'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Nick Name" name="dt[nick_name]" value="<?= $student_document['nick_name'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-place_of_birth" placeholder="Insert Place Of Birth" name="dt[place_of_birth]" value="<?= $student_document['place_of_birth'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-gender">GENDER</label>

                        <input disabled type="text" class="form-control" id="form-gender" placeholder="Insert Gender" name="dt[gender]" value="<?= $student_document['gender'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-identity_card_no">IDENTITY CARD NO</label>

                        <input disabled type="text" class="form-control" id="form-identity_card_no" placeholder="Insert Identity Card No" name="dt[identity_card_no]" value="<?= $student_document['identity_card_no'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-date_of_birth">DATE OF BIRTH</label>
                          <input disabled autocomplete="off" type="text" class="form-control pull-right tgl" id="datepicker"  name="dt[date_of_birth]" value="<?= $student_document['date_of_birth'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-weight" placeholder="Insert Weight" name="dt[weight]" value="<?= $student_document['weight'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-height">HEIGHT</label>

                        <input disabled type="text" class="form-control" id="form-height" placeholder="Insert Height" name="dt[height]" value="<?= $student_document['height'] ?>">

                    </div><div class="form-group col-md-12">

                        <label for="form-address">ADDRESS</label>

                        <input disabled type="text" class="form-control" id="form-address" placeholder="Insert Address" name="dt[address]" value="<?= $student_document['address'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-city">CITY</label>

                        <input disabled type="text" class="form-control" id="form-city" placeholder="Insert City" name="dt[city]" value="<?= $student_document['city'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-zip_code">ZIP CODE</label>

                        <input disabled type="text" class="form-control" id="form-zip_code" placeholder="Insert Zip Code" name="dt[zip_code]" value="<?= $student_document['zip_code'] ?>">

                    </div><div class="form-group col-md-12">

                        <label for="form-domicile_address">DOMICILE ADDRESS</label>

                        <input disabled type="text" class="form-control" id="form-domicile_address" placeholder="Insert Domicile Address" name="dt[domicile_address]" value="<?= $student_document['domicile_address'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-domicile_city">DOMICILE CITY</label>

                        <input disabled type="text" class="form-control" id="form-domicile_city" placeholder="Insert Domicile City" name="dt[domicile_city]" value="<?= $student_document['domicile_city'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-domicile_zip">DOMICILE ZIP</label>

                        <input disabled type="text" class="form-control" id="form-domicile_zip" placeholder="Insert Domicile Zip" name="dt[domicile_zip]" value="<?= $student_document['domicile_zip'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-home_telephone_number">HOME TELEPHONE NUMBER</label>

                        <input disabled type="text" class="form-control" id="form-home_telephone_number" placeholder="Insert Home Telephone Number" name="dt[home_telephone_number]" value="<?= $student_document['home_telephone_number'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-mobile_phone_number">MOBILE PHONE NUMBER</label>

                        <input disabled type="text" class="form-control" id="form-mobile_phone_number" placeholder="Insert Mobile Phone Number" name="dt[mobile_phone_number]" value="<?= $student_document['mobile_phone_number'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-marital_status">MARITAL STATUS</label>

                        <input disabled type="text" class="form-control" id="form-marital_status" placeholder="Insert Marital Status" name="dt[marital_status]" value="<?= $student_document['marital_status'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-email">EMAIL</label>

                        <input disabled type="text" class="form-control" id="form-email" placeholder="Insert Email" name="dt[email]" value="<?= $student_document['email'] ?>">

                    </div><div class="form-group col-md-6">

                        <label for="form-religion">RELIGION</label>

                        <input disabled type="text" class="form-control" id="form-religion" placeholder="Insert Religion" name="dt[religion]" value="<?= $student_document['religion'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality" placeholder="Insert Nationality" name="dt[nationality]" value="<?= $student_document['nationality'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_name]" value="<?= $family['father_name'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">PLACE & DATE OF BIRTH</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_place_of_birth]" value="<?= $family['father_place_of_birth'] ?>">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="form-nationality">FATHER'S ADDRESS</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_address]" value="<?= $family['father_address'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">CALL PHONE NUMBER</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_phone_number]" value="<?= $family['father_phone_number'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">FATHER'S OCCUPATION</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_occupation]" value="<?= $family['father_occupation'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">RESIDENCE PHONE NUMBER</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_residence_phone_number]" value="<?= $family['father_residence_phone_number'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">FATHER'S INCOME</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[father_income]" value="<?= $family['father_income'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">MOTHER'S NAME</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_name]" value="<?= $family['mother_name'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">PLACE & DATE OF BIRTH</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_place_of_birth]" value="<?= $family['mother_place_of_birth'] ?>">
                    </div>
                    <div class="form-group col-md-12">
                        <label for="form-nationality">MOTHER'S ADDRESS</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_address]" value="<?= $family['mother_address'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">CALL PHONE NUMBER</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_phone_number]" value="<?= $family['mother_phone_number'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">MOTHER'S OCCUPATION</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_occupation]" value="<?= $family['mother_occupation'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">RESIDENCE PHONE NUMBER</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_residence_phone_number]" value="<?= $family['mother_residence_phone_number'] ?>">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="form-nationality">MOTHER'S INCOME</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[mother_income]" value="<?= $family['mother_income'] ?>">
                    </div>
                    <?php
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered">
                            ...
                            <?php for($i=0;$i<5;$i++){ ?>
                              <tr>
                                <td><?=$i+1?></td>
                                <td><input disabled type="text" class="form-control" name="list_family[<?=$i?>][name]" value="<?=$list_family[$i]['name']?>"></td>
                                <td><input disabled type="text" class="form-control" name="list_family[<?=$i?>][gender]" value="<?=$list_family[$i]['gender']?>"></td>
                                <td><input disabled type="text" class="form-control" name="list_family[<?=$i?>][date_of_birth]" value="<?=$list_family[$i]['date_of_birth']?>"></td>
                                <td><input disabled type="text" class="form-control" name="list_family[<?=$i?>][relationship]" value="<?=$list_family[$i]['relationship']?>"></td>
                                <td><input disabled type="text" class="form-control" name="list_family[<?=$i?>][occupation]" value="<?=$list_family[$i]['occupation']?>"></td>
                              </tr>
                            <?php } ?>
                          </table>
                        </div>
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[e_name]" value="<?= $family['e_name'] ?>">
                        </div>
                        <div class="form-group col-md-6">
                        <label for="form-nationality">RELATIONSHIP</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[e_relationship]" value="<?= $family['e_relationship'] ?>">
                        </div>
                        <div class="form-group col-md-6">
                        <label for="form-nationality">PHONE NUMBER</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[e_phone_number]" value="<?= $family['e_phone_number'] ?>">
                        </div>
                        <div class="form-group col-md-6">
                        <label for="form-nationality">ADDRESS</label>
                        <input disabled type="text" class="form-control" id="form-nationality"  name="family[e_address]" value="<?= $family['e_address'] ?>">
                        </div>
                        ...
                        <div class="table-responsive">
                          <table class="table table-bordered">
                            ...
                            <?php for($i=0;$i<5;$i++){ ?>
                              <tr>
                                <td><?=$i+1?></td>
                                <td><input disabled type="text" class="form-control" name="qualification[<?=$i?>][edutype]" value="<?=$qualification[$i]['edutype']?>"></td>
                                <td><input disabled type="text" class="form-control" name="qualification[<?=$i?>][school]" value="<?=$qualification[$i]['school']?>"></td>
                                <td><input disabled type="text" class="form-control" name="qualification[<?=$i?>][graduation_date]" value="<?=$qualification[$i]['graduation_date']?>"></td>
                                <td><input disabled type="text" class="form-control" name="qualification[<?=$i?>][major]" value="<?=$qualification[$i]['major']?>"></td>
                              </tr>
                            <?php } ?>
                          </table>
                        </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality" name="others[pertanyaan_1]" value="<?= $others['pertanyaan_1'] ?>">
  ...
  <input disabled type="text" class="form-control" id="form-nationality" name="others[pertanyaan_2]" value="<?= $others['pertanyaan_2'] ?>">
  ...
  ?>
  <input disabled <?=$a?> type="radio" class="" id="form-nationality" name="others[applicant]" value="YES"> YES 
  <input disabled <?=$b?> type="radio" class="" id="form-nationality" name="others[applicant]" value="NO"> NO 
  ...
  ?>
  <input disabled <?=$a?> type="radio" class="" id="form-nationality" name="others[parent]" value="YES"> YES 
  <input disabled <?=$b?> type="radio" class="" id="form-nationality" name="others[parent]" value="NO"> NO 
  ...
  <input disabled type="text" class="form-control" id="form-nationality" name="others[note]" value="<?= $others['note'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality" placeholder="Insert T-Shirt Size" name="dt[t_shirt_size]" value="<?= $student_document['t_shirt_size'] ?>">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input disabled type="text" class="form-control" id="form-nationality" placeholder="Insert Shoes Size" name="dt[shoes_size]" value="<?= $student_document['shoes_size'] ?>">
  ...
  <div class="form-group col-md-12">
            ...
            <?php } ?>
            <input disabled autocomplete="off" type="file" class="form-control" id="form-file" placeholder="Insert File" name="file">
              </div>
