...
?>
<select disabled style='width:100%' name="dt[role]" class="form-control select2">
...
<input readonly type="text" class="form-control" id="form-desc" placeholder="Fill Position" name="dt[position]" value="<?= $user['position'] ?>">
...
<input readonly type="text" class="form-control" id="form-desc" placeholder="Fill Remark" name="dt[remark_instructor]" value="<?= $user['remark_instructor'] ?>">
