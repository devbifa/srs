  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/ftd_flight_instructor_document/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  ...
                  Tambah Ftd Flight Instructor Document
  ...
  <div class="row">
                <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control" id="form-license" placeholder="Masukan License" name="dt[license]">

                  </div><div class="form-group col-md-12">

                      <label for="form-course_capabilities">COURSE CAPABILITIES</label>

                      <input type="text" class="form-control" id="form-course_capabilities" placeholder="Masukan Course Capabilities" name="dt[course_capabilities]">
