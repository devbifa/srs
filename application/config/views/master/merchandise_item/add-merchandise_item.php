  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Merchandise_item/store') ?>" id="upload-create" enctype="multipart/form-data">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <select style='width:100%' name="dt[id_merchandise]" class="form-control select2">
                        ...
                        foreach ($merchandise as $merchandise_record) {
                          ...
                          echo "<option value=".$merchandise_record['id'].">".$merchandise_record['nama_merchandise']."</option>";
...
<input required type="file" class="form-control" id="form-file" multiple="multiple" name="files[]" accept="image/x-png,image/gif,image/jpeg" >
