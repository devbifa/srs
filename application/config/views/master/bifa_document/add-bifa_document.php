  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/bifa_document/store') ?>" id="upload-create" enctype="multipart/form-data">
  ...
  <div class="row">
                <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control" id="form-pcs" placeholder="Masukan Pcs" name="dt[pcs]">

                  </div><div class="form-group col-md-12">

                      <label for="form-pcs_valid_date">PCS VALID DATE</label>

                      <input value="<?=DATE('Y-m-d')?>" autocomplete="off" type="text" class="form-control tgl" id="form-pcs_valid_date" placeholder="Masukan Pcs Valid Date" name="dt[pcs_valid_date]">

                  </div><div class="form-group col-md-12">

                      <label for="form-opspec_issued_date">OPSPEC ISSUED DATE</label>

                      <input value="<?=DATE('Y-m-d')?>" autocomplete="off" type="text" class="form-control tgl" id="form-opspec_issued_date" placeholder="Masukan Opspec Issued Date" name="dt[opspec_issued_date]">
