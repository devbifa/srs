  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/course/store') ?>" id="upload-create" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box-header-material box-header-material-text">
                ...
                ?>
                <?=($curriculum['curriculum'])?> > COURSE > CREATE
                </div>
                <div class="col-xs-2">
...
<div class="col-md-12">
<?php
  // $curriculum = $this->mymodel->selectDataOne('curriculum', array('id'=>$course['curriculum']));
?>
<div class="row">
<div class="form-group col-md-3">
      ...
      <select style='width:100%' name="dt[curriculum]" class="form-control select2">
        ...
        $curriculum2 = $this->mymodel->selectWhere('curriculum',array('id'=>$curriculum['id']));
...
<input type="text" class="form-control" id="form-course_code" placeholder="Masukan Course" name="dt[code]" value="<?= $course['code'] ?>">
  ...
  <?php
  $id_curriculum = $this->uri->segment(4);
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('master/curriculum/course/').$id ?>";
