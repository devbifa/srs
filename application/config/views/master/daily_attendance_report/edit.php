...
.hidden{
  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/daily_attendance_report/update') ?>" id="upload-create" enctype="multipart/form-data">
...
<input disabled autocomplete="off" type="text" class="form-control tgl" id="form-date" placeholder="Masukan Date" name="dt[date]" value="<?= $daily_ground_schedule['date'] ?>">
...
<option value="<?= $tpm['code'] ?>"><?= $tpm['curriculum'] ?></option>
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <select disabled style='width:100%' name="dt[classroom]" class="form-control select2">
...
<select disabled style='width:100%' name="dt[subject]" class="form-control select2" id="mission">
...
<select disabled style='width:100%' name="dt[instructor]" class="form-control select2" id="instructor">
...
<input disabled type="text" class="form-control" id="form-remark" placeholder="Masukan Remark" name="dt[remark]" value="<?= $daily_ground_schedule['remark'] ?>">
...
<div class="form-group col-md-3">
                      ...
                      <input disabled type="text" class="form-control" id="etd2" placeholder="Masukan Start UTC" name="dt[start_lt]" value="<?= $daily_ground_schedule['start_lt'] ?>">
...
<input  disabled type="text" class="form-control" id="eet2" placeholder="Masukan Duration" name="dt[duration]" value="<?= $daily_ground_schedule['duration']?>">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <input disabled type="text" class="form-control" id="eta2" placeholder="Masukan Stop UTC" name="dt[stop_lt]" value="<?= $daily_ground_schedule['stop_lt'] ?>">
...
<input type="text" class="form-control" id="etd2" placeholder="Masukan Start UTC" name="dt[start_act]" value="<?= $daily_ground_schedule['start_act'] ?>">
...
<input type="text" class="form-control" id="eet2" placeholder="Masukan Duration" name="dt[duration_act]" value="<?= $daily_ground_schedule['duration_act'] ?>">
...
<input type="text" class="form-control" id="eta2" placeholder="Masukan Stop UTC" name="dt[stop_act]" value="<?= $daily_ground_schedule['stop_act'] ?>">
                ...
                success: function(response, textStatus, xhr) {
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        <?php }else{ ?>
                          window.location.href = "<?= base_url('master/daily_attendance_report') ?>";
                        <?php } ?>
