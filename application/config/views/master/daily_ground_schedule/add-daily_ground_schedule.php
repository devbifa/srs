...
.hidden{
  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/daily_ground_schedule/store') ?>" id="upload-create" enctype="multipart/form-data">
...
<button type="button" class="btn btn-block btn-warning"><i class="mdi mdi-arrow-up-bold-circle-outline"></i> EXPORT DATA</button> 
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url('fitur/import/daily_ground_schedule') ?>" method="POST"  enctype="multipart/form-data">
...
<th style="min-width:100px;" rowspan="2">ACTION</th><th rowspan="2" style="min-width:110px;">DATE</th>
<th rowspan="2" >CLASS<br>ROOM</th>
<th rowspan="2" >INSTRUCTOR</th>
<th rowspan="2" >BATCH</th>
<th rowspan="2" >COURSE</th><th rowspan="2" >SUBJECT</th><th colspan="3">TIME (UTC)</th><th rowspan="2" >PARTICIPANT</th><th rowspan="2" >REMARK</th><th rowspan="2" >PROPOSE</th> 
</tr>
...
<?php
      ...
      ON a.classroom = b.code
			WHERE DATE(a.date) >= '$start_date' AND DATE(a.date) <= '$end_date' AND a.visibility = '0'  AND start_lt >= '22:00' AND start_lt <= '24:00'
			 "
			  .$base
			  .$batch.
			 "
...
<td><a href="<?=base_url()?>master/daily_ground_schedule/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/daily_ground_schedule/delete_data/<?=$val['id']?>">Delete Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<td><?=$participant?></td> 
<td class="text-left"><?=$val['remark']?></td><td class=""><?=$sent?></td></td> 
</tr>
<?php } ?>
...
LEFT JOIN classroom b
ON a.classroom = b.code
WHERE DATE(a.date) >= '$start_date' AND DATE(a.date) <= '$end_date' AND a.visibility = '0' AND start_lt >= '00:00' AND start_lt <= '21:59'
 "
  .$base
  .$batch.
 "
...
<div class="modal modal-success fade" id="modal-submit">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/daily_ground_schedule/submit" id="submit-now" >Propose Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<script type="text/javascript">
  ...
  foreach ($batch_data as $val) {
    ...
    $text2 .= "<option value='".$val['id']."' ".$text." >".$val['batch'].' ('.$val['curriculum'].")</option>";
  ...
  ?>
    ...
    $('#addstudent').click(function() {
      ...
      '<td style="min-width:100px;"><select required class="select2 batch text-left" style="width:100%;" name="dttt['+i+'][batch]" id="batch'+i+'" >'+text+'</select></td>'+
      '<td colspan="3"><select required class="select2 id_number text-left" style="width:100%;" name="dttt['+i+'][id_number]" id="id_number'+i+'" ><option value="">SELECT STUDENT</option</select></td>'+
