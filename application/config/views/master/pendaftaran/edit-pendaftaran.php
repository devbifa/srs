  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Pendaftaran/update') ?>" id="upload-create" enctype="multipart/form-data">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  Edit Pendaftaran
                  <a href="https://nsoproject.com/event/invoice/<?= $pendaftaran['kode_pendaftaran'] ?>" target="_blank" class="btn btn-primary"> Invoice</a>
                  <a href="<?=base_url()?>master/pendaftaran/edit-invoice/?kode=<?= $pendaftaran['kode_pendaftaran'] ?>" target="_blank" class="btn btn-warning"> Edit</a>
              </h5>
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <select style='width:100%' name="dt[event]" class="form-control select2">
                        ...
                        foreach ($event as $event_record) {
                          ...
                          if($event_record['id']==$pendaftaran['event']){
                      ...
                      <input type="text" class="form-control" id="form-kode_pendaftaran" placeholder="Masukan Kode Pendaftaran" name="dt[kode_pendaftaran]" value="<?= $pendaftaran['kode_pendaftaran'] ?>">
                      ...
                      <select style='width:100%' name="dt[tipe_pendaftaran]" class="form-control select2">
                        ...
                        foreach ($tipe_pendaftaran as $tipe_pendaftaran_record) {
                          ...
                          if($tipe_pendaftaran_record['nama_tipe_pendaftaran']==$pendaftaran['tipe_pendaftaran']){
                      ...
                      <select style='width:100%' name="dt[status_pendaftaran]" class="form-control select2">
                        ...
                        foreach ($status_pendaftaran as $status_pendaftaran_record) {
                          ...
                          if($status_pendaftaran_record['nama_status_status_pendaftaran']==$pendaftaran['status_pendaftaran']){
                          ...
                          echo "<option value=".$status_pendaftaran_record['nama_status_status_pendaftaran']." ".$text." >".$status_pendaftaran_record['nama_status_status_pendaftaran']."</option>";
