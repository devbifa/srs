  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/batch/update') ?>" id="upload-create" enctype="multipart/form-data">
...
<input type="text" class="form-control" id="form-batch" placeholder="Fill Batch" name="dt[batch]" value="<?= $batch['batch'] ?>">
...
<select style='width:100%' name="dt[status]" class="form-control select2">
  ...
  ?>
               ...
               <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control tgl" id="form-description" placeholder="Fill Open Date" name="dt[description]" value="<?= $batch['description'] ?>">
  ...
  <div class="row">
            ...
            <div class="col-md-12">
            <div class="row">
                <button type="submit" class="btn btn-primary btn-send float-1"  data-placement="top" title="SAVE BATCH" ><i class="mdi mdi-content-save"></i></button>
