  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Gallery_item/update') ?>" id="upload-create" enctype="multipart/form-data">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <select style='width:100%' name="dt[gallery]" class="form-control select2">
                        ...
                        foreach ($gallery as $gallery_record) {
                          ...
                          if($gallery_record['id']==$gallery_item['gallery']){
                      ...
                      <input type="text" class="form-control" id="form-file" placeholder="Masukan File" name="dt[file]" value="<?= $gallery_item['file'] ?>">
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('master/Gallery_item') ?>";
