  ...
  <div class="content-wrapper">
    ...
    <input autocomplete="off" type="hidden" class="form-control tgl" id="form-date" placeholder="Masukan Date" name="dt[origin_base]" value="WSN">
          ...
          <div class="box-header-material box-header-material-text">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-3">
                      ...
                      <input autocomplete="off" type="text" class="form-control tgl" id="form-date" placeholder="Masukan Date" name="dt[date]" value="<?=DATE('Y-m-d') ?>">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <select style='width:100%' name="dt[ftd_model]" class="form-control select2 ">
...
?>
                 ...
                 <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" id="etd2" placeholder="Masukan Etd Utc" name="dt[etd_utc]" value="<?= $daily_ftd_schedule['etd_utc'] ?>">
...
<input type="text" class="form-control" id="eet2" placeholder="Masukan Eet Utc" name="dt[eet_utc]" value="<?= $daily_ftd_schedule['eet_utc'] ?>">
                  ...
                  <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" id="eta2" placeholder="Masukan Eta" name="dt[eta]" value="<?= $daily_ftd_schedule['eta'] ?>">
...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    ...
    <form action="<?= base_url('fitur/import/daily_ftd_schedule') ?>" method="POST"  enctype="multipart/form-data">
...
<th style="min-width:110px">DATE</th><th style="width:120px;">FTD MODEL</th><th>INSTRUCTOR</th><th>STUDENT</th><th>BATCH</th><th>COURSE</th><th>MISSION</th><th>ETD <br>UTC</th><th>ETA<br>UTC</th><th>EET</th><th>REMARK</th><th>PROPOSE</th>
...
<tr>
  ...
  <td><a href="<?=base_url()?>master/daily_ftd_schedule/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
...
<div class="modal modal-danger fade" id="modal-delete-<?=$val['id']?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/daily_ftd_schedule/delete_data/<?=$val['id']?>">Delete Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
  ...
  <?php 
    ...
    ?>
  <td class="text-left"><?=$val['mission']?></td></td><td><?=$val['etd_utc']?></td><td><?=$val['eta']?></td><td><?=$val['eet_utc']?><td class="text-left"><?=$val['remark']?></td><td class=""><?=$sent?></td>
</tr>
<?php } ?>
...
<tr>
  ...
  <td><a href="<?=base_url()?>master/daily_ftd_schedule/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
     <ahref="#!" data-toggle="modal" data-target="#modal-delete-<?=$val['id']?>" class="btn btn-danger btn-rounded btn-xs"><i class="mdi mdi-delete"></i></a>
...
<a href="#!" data-toggle="modal" data-target="#modal-submit" id="button-submit" class="btn btn-primary pull-right" >PROPOSE FOR APPROVAL</a>
...
<div class="modal modal-success fade" id="modal-submit">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/daily_ftd_schedule/submit" id="submit-now" >Propose Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('master/daily_ftd_schedule/create') ?>";
