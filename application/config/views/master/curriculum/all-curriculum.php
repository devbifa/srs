...
<button type="button" class="btn btn-sm btn-success float-1"  data-placement="top" title="ADD CURRICULUM" ><i class="mdi mdi-plus"></i></button> 
            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="pull-right">          <a href="<?= base_url('master/curriculum/create') ?>">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                  ...
                  //  '<th>CODE</th>'+
                   '<th>CURRICULUM</th>'+'<th>DATE OF APPROVAL</th>'+'<th style="text-align:center!important;">HIGHLIGHT</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                ajax: {"url": "<?= base_url('master/curriculum/json?status=') ?>"+status, "type": "POST"},

                columns: [

                    {"data": "id","orderable": false},
                    // {"data": "code"},
                    {"data": "curriculum"},{"data": "approval_date"},{"data": "description"},
...
render : function (data, type, row, meta) {
     ...
     htmls = '<a  href="<?=base_url()?>master/curriculum/course/'+row['code']+'">'+row['curriculum']+'</a>'
...

{
      ...
      function edit(id) {
            ...
            location.href = "<?= base_url('master/curriculum/edit/') ?>"+id;

         }
         function preview(id) {

          location.href = "<?= base_url('master/curriculum/preview/') ?>"+id;
