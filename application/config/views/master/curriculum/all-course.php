...
<a href="<?=base_url()?>master/curriculum/edit/<?=$curriculum['id']?>" class="btn btn-primary pull-right float-4"  data-placement="top" title="EDIT CURRICULUM" ><i class="fa fa-pencil"></i></a>
