      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>master/daily_approval_report/filter" method="post">
                                <div class="col-md-2">
...
$start_date = $_SESSION['start_date'];
      ...
      foreach($data as $key=>$val){
        ...
        $val['prepared_by'] = $dat['nick_name'].'<br>'.$role['role'];

        $dat = $this->mymodel->selectDataOne('user', array('id'=>$val['approved_by']));
        $role = $this->mymodel->selectDataOne('role', array('id'=>$dat['role']));

        $val['approved_by'] = $dat['nick_name'].'<br>'.$role['role'];

        $dat = $this->mymodel->selectDataOne('user', array('id'=>$val['approved_by_2']));
        $role = $this->mymodel->selectDataOne('role', array('id'=>$dat['role']));

        $val['approved_by_2'] = $dat['nick_name'].'<br>'.$role['role'];
...
<td style="min-width:50px;">
  ...
  <a href="<?=base_url()?>master/daily_approval_report/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval_report/approve_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
...
<div class="modal modal-success fade" id="modal-approve2-<?=$val['id']?>-FLIGHT">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="color:#fff!important;">
        <form action="<?=base_url()?>master/daily_approval_report/approve_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
        <div class="form-group">
        <p>Are you sure to approve this REPORT?</p>
...
<div class="modal modal-warning fade" id="modal-rollback-<?=$val['id']?>-FLIGHT">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval_report/rollback_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
        ...
        <div class="modal modal-warning fade" id="modal-rollback2-<?=$val['id']?>-FLIGHT">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval_report/rollback_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                <p>Are you sure to rollback this REPORT?</p>
