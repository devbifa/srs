  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/delay_and_cancel_code_type/store') ?>" id="upload-create" enctype="multipart/form-data">
  ...
  <div class="row">
                <div class="form-group col-md-3">
                      ...
                      <input type="text" class="form-control" id="form-delay_and_cancel_code_type" placeholder="Fill Irregularities Type" name="dt[delay_and_cancel_code_type]">
