  ...
  <div class="row">
    ...
    <div class="col-xs-12">
      ...
      <div class="box">
        ...
        <div class="row">
                        <div class="">
                            <form autocomplete="off" action="<?= base_url() ?>menu/my_report_approval/filter" method="post">
                            <div class="col-md-2">
...
$start_date = $_SESSION['start_date'];
  ...
  $data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'FLIGHT REPORT'  AND (prepared_by='$my_id' OR approved_by='$my_id') ORDER BY date DESC");
...
<!-- <a href="<?=base_url()?>menu/my_report_approval/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a> -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body" style="color:#fff!important;">
           <form action="<?=base_url()?>menu/my_report_approval/approve_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
...
<div class="modal-content">
  ...
  <div class="modal-body" style="color:#fff!important;">
    <form action="<?=base_url()?>menu/my_report_approval/approve_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
    <div class="form-group">
    <p>Are you sure to approve this report?</p>
...
<div class="modal modal-warning fade" id="modal-rollback-<?=$val['id']?>-FLIGHT">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body" style="color:#fff!important;">
           <form action="<?=base_url()?>menu/my_report_approval/rollback_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
    ...
    <div class="modal modal-warning fade" id="modal-rollback2-<?=$val['id']?>-FLIGHT">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body" style="color:#fff!important;">
           <form action="<?=base_url()?>menu/my_report_approval/rollback_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
            <div class="form-group">
            <p>Are you sure to rollback this report?</p>
...
$start_date = $_SESSION['start_date'];
  ...
  $data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'FTD REPORT'  AND (prepared_by='$my_id' OR approved_by='$my_id') ORDER BY date DESC");
...
$start_date = $_SESSION['start_date'];
  ...
  $data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'GROUND REPORT'  AND (prepared_by='$my_id' OR approved_by='$my_id') ORDER BY date DESC");
  $nomor = 0;
  foreach($data as $key=>$val){
    $id_approved_by = $val['approved_by'];
    $id_approved_by_2 = $val['approved_by_2'];
