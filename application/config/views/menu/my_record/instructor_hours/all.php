...
<tbody>
<?php 
$data = $this->mymodel->selectWithQuery("SELECT a.start_act, a.stop_act, a.duration_act, a.student, a.student_attend, a.student_other, a.student_other_attend, a.id,a.date,g.batch, CONCAT(c.base,' (',b.classroom,')') as classroom,d.course_code as course,e.name as subject,f.nick_name as instructor,a.duration,a.start_lt,a.stop_lt,a.remark,a.status
FROM
...
ON b.station = h.id
WHERE a.visibility = '1' AND a.visibility_report = '1'   AND a.instructor = '$pic' AND DATE(date) >= '$start_date' AND DATE(date) <= '$end_date'
AND a.duration_act NOT IN ('-','','00:00','0:00')
...
WHERE a.visibility = '1' AND a.type = '' AND a.visibility_report = '1'   AND (a.pic = '$pic' OR a.2nd = '$pic' OR a.duty_instructor = '$pic') AND DATE(date_of_flight) >= '$start_date' AND DATE(date_of_flight) <= '$end_date'
AND a.block_time_total NOT IN ('-','','00:00','0:00')
ORDER BY
...
WHERE a.visibility = '1' AND a.visibility_report = '1'  AND a.type = '' AND (a.duty_instructor = '$pic') AND DATE(date_of_flight) >= '$start_date' AND DATE(date_of_flight) <= '$end_date'
