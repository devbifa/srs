        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
               ...
               <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>record/irregularities/filter" method="post">
                                    <div class="col-md-4">
...
foreach($data as $key=>$val){
  ...
  WHERE remark_dmr = '$code' AND visibility = '1' AND visibility_report = '1' AND DATE(date_of_flight) >= '$start_date' AND DATE(date_of_flight) <= '$end_date' ".$origin_base." 
  ");
  ...
  <tr>
    ...
    <td><?=$total_ground?></td>
    <td><?=$total_ftd?></td>
    <td><a  href="<?=base_url()?>master/daily_movement_report_approved/?irreg=<?=$val['code']?>"><?=$total_flight?></a></td>
    <td><?=$total_all?></td>
  </tr>
<?php } 
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($statistik as $key => $k) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left"><?= $k['type'] ?></td>
                                                    <td style="text-align:right;"><a  href="<?=base_url()?>master/daily_movement_report_approved/?irreg_type=<?=$k['type']?>"><?= $k['count_flight'] ?></a></td>
