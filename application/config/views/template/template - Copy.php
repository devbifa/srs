        ...
        <div class="collapse navbar-collapse pull-left menu-custom_css" style="margin-left: 5px;" id="navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            foreach ($menu as $m) {
              ...
              if (count($parent) == 0) {
                ?>
                   <a class="dropdown-item" style="font-size:11px;" href="<?= base_url($m['link']) ?>"><i class="<?= $m['icon'] ?>"></i> <?= $m['name'] ?></a>
              <?php } else { ?>
                    ...
                    <?php }else{ ?>
                      <li class="nav-item dropdown d-m">
                        ...
                        <?php foreach ($parent_child as $pc) { ?>
                          <li>
                          <a class="dropdown-item" style="font-size:11px;" href="<?= base_url($pc['link']) ?>"><i class="<?= $pc['icon'] ?>"></i> <?= $pc['name'] ?></a>
                        </li>
                        <?php } ?>
                        </ul>
                      </li>
