...
if ($base) {
  $base = "  AND a.origin_base = '$origin_base' ";
} else {
  $base = " ";
}
...
<body>
    <table class="table table-bordered table-striped" id="" style="width:100%">
        ...
        <tr>
            <th colspan="13" style="font-size:12px;"><?= $date ?>
            </th>
        </tr>
        <tr class="bg-success">
...
ORDER BY a.date ASC,a.start_lt ASC");
      ...
      ?>
        <tr>
            ...
            <td class="text-left" style="width:8%"><?= $val['instructor'] ?></td>
            <td style="width:5%"><?= $val['type'] ?></td>
