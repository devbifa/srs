          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div>
                   ...
                   <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>dashboard/ftd_report/filter" method="post">
                                <div class="col-md-2">
                ...
                <?php 
                  ...
                  ?>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>&nbsp</label><br>
                                            <a class="btn btn-success btn-block" href="<?=base_url()?>features/print_ftd_report" target="_blank"><i class="mdi mdi-printer"></i> PRINT</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
