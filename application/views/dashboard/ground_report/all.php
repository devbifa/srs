          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div>
                   ...
                   <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>dashboard/ground_report/filter" method="post">
                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>&nbsp</label><br>
                                            <a class="btn btn-success btn-block" href="<?=base_url()?>features/print_ground_report" target="_blank"><i class="mdi mdi-printer"></i> PRINT</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<th style="width:20px" rowspan="2">NUM</th><th style="min-width:50px;" rowspan="2">DATE</th>
<th rowspan="2" >CLASS<br>ROOM</th>
<th rowspan="2" >INSTRUCTOR</th>
<th rowspan="2" >TYPE</th>
<th rowspan="2" >BATCH</th>
<th rowspan="2" >TPM</th>
<th rowspan="2" >COURSE</th><th rowspan="2" >SUBJECT</th><th colspan="3">TIME PLAN (UTC)</th><th colspan="3">TIME ACT (UTC)</th>
...
<tr>
  ...
  <td><?=DATE('d M Y',strtotime($val['date']))?></td><td><?=$val['classroom']?></td> <td class="text-left"><?=$val['instructor']?></td><td><?=$val['type']?></td>  <td><?=$val['batch']?></td><td><?=$val['tpm']?></td> <td><?=$val['course']?></td> <td class="text-left">
  
  <?=$val['subject']?></td> 
  <td><?=$val['start_lt']?></td> <td><?=$val['stop_lt']?></td><td><b><?=$val['duration']?></b></td> <td><?=$val['start_act']?></td> <td><?=$val['stop_act']?></td><td><b><?=$val['duration_act']?></b></td> 
  <td><?=$participant?></td> 
  <td><?=$attend?></td> 
...
<tr>
  ...
  <td><?=DATE('d M Y',strtotime($val['date']))?></td><td><?=$val['classroom']?></td> <td class="text-left"><?=$val['instructor']?></td><td><?=$val['type']?></td>  <td><?=$val['batch']?></td><td><?=$val['tpm']?></td> <td><?=$val['course']?></td> 
 
  <td class="text-left"><?=$val['subject']?></td> <td><?=$val['start_lt']?></td> <td><?=$val['stop_lt']?></td><td><b><?=$val['duration']?></b></td> <td><?=$val['start_act']?></td> <td><?=$val['stop_act']?></td><td><b><?=$val['duration_act']?></b></td> 
  <td><?=$participant?></td> 
  <td><?=$attend?></td> 
  <td><?=$val['remark']?></td>  <td><?=$val['remark_report']?></td> 
</tr>
