...
<tr class="bg-success">
  ...
  <th style="width:20px">NUM</th><th style="min-width:50px">DATE</th><th style="width:170px;">FTD MODEL</th><th>INSTRUCTOR</th><th>STUDENT</th><th>BATCH</th><th>TPM</th><th>COURSE</th><th>MISSION</th><th>ETD <br>UTC</th><th>ETA<br>UTC</th><th>EET</th><th>REMARK</th>
</tr>
...
<tr>
  ...
  <td class="text-left"><?=$val['pic']?></td><td class="text-left"><?=$val['2nd']?></td><td><?=$val['batch']?></td><td><?=$val['tpm']?></td>
  ...
  <?php 
    ...
    ?>
  <td class="text-left"><?=$val['mission']?></td></td><td><?=$val['etd_utc']?></td><td><?=$val['eta']?></td><td><b><?=$val['eet_utc']?></b></td><td class="text-left"><?=$val['remark']?></td>
</tr>
<?php } ?>
