...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            ?>
                        <?php if ($_SESSION['instructor_status'] == "1") { ?>
                  ...
                  ?>
                        ...
                        <table style="width:100%;">
                            ...
                            <tr>
                                <th colspan="3" style="font-size:15px;padding:5px 0px;" class="text-left">CURRICULUM
                                </th>
                                <th>:</th>
                        ...
                        <div class="row">
                            <div class="">
                                <form autocomplete="off"
                                    action="<?= base_url() ?>menu/my_record/filter/<?= $student['id'] ?>" method="post">
                                    <div class="col-md-2">
  ...
  AND a.duration_act NOT IN ('-','','00:00','0:00') AND a.instructor = '$pic'
