            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select onchange="loadtable(this.value)" id="select-status" style="width: 250px"
                                    class="form-control">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>report/flight_report/filter"
                                    method="post">
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-success btn-block"
                                                href="<?= base_url() ?>features/print_flight_report" target="_blank"><i
                            ...
                            <table class="table table-bordered table-striped" id="datatable" style="width:100%">
                                ...
                                <thead>
                                    ...
                                    <tr class="bg-success">
                                        ...
                                        <th rowspan="2">ETD<br>UTC</th>
                                        <th rowspan="2">ETA<br>UTC</th>
                                        <th rowspan="2">EET</th>
                                        <th colspan="3">
                                            BLOCK TIME
                                        </th>
...
<div class="modal modal-danger fade" id="modal-delete">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="upload-delete" action="<?= base_url('report/flight_schedule/delete') ?>">
