...
$c = strtoupper(str_replace(".php", "", $controller));
  ...
  <div class=\"content-wrapper\">
    ...
    <section class=\"content\">
      ...
      if($form_type=="page"){
       ...
       $stringall .= "          <a href=\"<?= base_url('master/".strtolower($c)."/create') ?>\">
...
$stringall .=     "'<th>".strtoupper($this->template->label($value))."</th>'+";
...
$stringall.=   "'       <th style=\"min-width:50px\">STATUS</th>'+
...
if($form_type=="page"){
  $stringall.="   
      ...
      function edit(id) {
            ...
            location.href = \"<?= base_url('master/".strtolower($c)."/edit/') ?>\"+id;

         }
         function preview(id) {

          location.href = \"<?= base_url('master/".strtolower($c)."/preview/') ?>\"+id;
