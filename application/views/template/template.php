...
<body class="hold-transition <?=SKIN?> layout-top-nav scroll-bar">
      ...
      <span class="logo-lg"><img src="<?=base_url()?>assets/logo.png" style="height:31px" alt=""> SRS BIFA</span>
        ...
        <div class="collapse navbar-collapse pull-left menu-custom_css" style="margin-left: 5px;" id="navbar-collapse">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown"> <span><i class="mdi mdi-database"></i> INPUT DATABASE</span> <span class="mdi mdi-arrow-down-drop-circle"></span> </a>
            <ul class="dropdown-menu d-m">
                                            
                                                                    <li>
                    <a style="font-size:13px;" class="dropdown-item" href="<?=base_url()?>master/user"><i class="mdi mdi-checkbox-blank-circle-outline"></i> USER</a>
                  </li>
                                                                    <li>
                    <a style="font-size:13px;" class="dropdown-item" href="<?=base_url()?>master/role"><i class="mdi mdi-checkbox-blank-circle-outline"></i> ROLE</a>
                  </li>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="height: 201px">
                ...
                <p>
                <?= substr(strtoupper($user['id_number']),0,27)?>  <br>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">PROPOSE TO FINANCE</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="">
                <span style="font-weight:100">Are you sure you want to propose to finance this application student?</span>
               </form>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/student_list/approve/<?=$student_application_form['id']?>">Propose to Finance Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
...
<div class="modal modal-success fade" id="modal-active">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>/master/student_list/status/<?=$student_application_form['id']?>/ACTIVE">Activate Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
        ...
        <div class="modal modal-success fade" id="modal-active-document">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal modal-success fade" id="modal-contract">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">PROPOSE TO MARKETING FOR CONTRACT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="">
                <span style="font-weight:100">Are you sure you want to propose to marketing for contract this student?</span>
               </form>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>/master/student_list/propose_to_contract/<?=$student_application_form['id']?>">Propose to Contract Now</a>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
