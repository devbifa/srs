            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-5 text-right color-white">
                    ...
                    <div class="show_error"></div>
                        <input type="text" class="form-control" style="margin-bottom:10px;" id="username" name="username" value="" placeholder="Username" required="" autofocus="">
                        <input type="password" class="form-control" style="margin-bottom:7px;" id="password" name="password" placeholder="Password" required="">
