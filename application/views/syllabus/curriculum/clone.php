  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('syllabus/curriculum/clone_process') ?>" id="upload-create" enctype="multipart/form-data">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box-header-material box-header-material-text">
                <div class="row">
                <div class="col-xs-10">
                CLONE SYLLABUS CURRICULUM <?=$data['name']?> CONFIGURATION
                </div>
                <div class="col-xs-2">
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('syllabus/curriculum') ?>";
