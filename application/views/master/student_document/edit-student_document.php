                                                        ...
                                                        <tr class="bg-success">
                                                            ...
                                                            <th class="text-center">
                                                                <a href="#!" data-toggle="modal"
                                                                    data-target="#modal-add-log-<?= $i ?>"
                                                                    class="btn btn-primary btn-xs btn-block">ADD</a>
                                                            </th>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h4 class="modal-title">ADD PAYMENT HISTORY
                                                                            </h4>
                                                                        </div>
                                                                        <div class="modal-body"
                                                                            style="color:#fff!important;">
                                                                            <form
                                                                                action="<?= base_url() ?>master/student_document/store_payment"
                                                                                method="POST"
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <textarea autocomplete="off"
                                                                                        ...
                                                                                        class="form-control"
                                                                                        name="dttt[description]"><?= $val['description'] ?></textarea>
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label>Attachment File</label>
                                                                                    *empty if not updated.
                            ...
                            ?>
                                  ...
                                  ?>
                                                            ...
                                                            <td class="text-left" style="width:100px;">
                                                                ...
                                                                <a href="#!" class="btn btn-warning btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-upload-log-<?= $i ?>"><i
                                                                        class="mdi mdi-pencil"></i></a>
                                                                <a href="#!" class="btn btn-danger btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-delete-log-<?= $i ?>"><i
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">UPDATE PAYMENT
                                                                                    HISTORY</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                                <form
                                                                                    action="<?= base_url() ?>master/student_document/update_payment"
                                                                                    method="POST"
                                                                                    enctype="multipart/form-data">
                                                                                    <div class="form-group">
                                                                                        <label>Payment Name</label>
                                                                    ...
                                                                    <div class="modal-dialog">
                                                                        <div class="modal-content">
                                                                            ...
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                                <form action="">
                                                                                    <span style="font-weight:100">Are
                                                                                        you sure you want to delete this
                                                                                        log payment status?</span>
                                                                                </form>
                                                                            </div>
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                                                ...
                                                                                <a type="button" class="btn btn-outline"
                                                                                    href="<?= base_url() ?>master/student_document/delete_payment/<?= $student_document['id'] ?>/<?= $val['id'] ?>">Delete
                                                                                    Now</a>
                                                                            </div>
                                                                        </div>
                                                                        <!-- /.modal-content -->
                        ...
                        <form method="POST" action="<?= base_url('master/Student_document/update') ?>"
                            ...
                            <div class="box">
                                ...
                                <div class="box-header-material box-header-material-text">
                                    <div class="row">
                                        <div class="col-xs-10">
                                            EDIT STUDENT STATUS : <?= $student_document['status'] ?>
                                        </div>
                                        <div class="col-xs-2">
                                            <div class="box-tools pull-right">
                                                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i
                            ...
                            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" style="width:70px;">
                                                                ...
                                                                <a href="#!" class="btn btn-warning btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-upload-<?= $i ?>"><i
                                                                        class="mdi mdi-pencil"></i></a>
                                                                <a href="#!" class="btn btn-danger btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-delete-<?= $i ?>"><i
                                                                        class="mdi mdi-delete"></i></a>
                                                                <?php
                                  if ($att[$val['id']]['file']) { ?>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">UPDATE ARCHIVE
                                                                                    DOCUMENT</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                                <form
                                                                                    action="<?= base_url() ?>master/student_document/update_file/<?= $student_document['id'] ?>/<?= $val['id'] ?>"
                                                                                    method="POST"
                                                                                    enctype="multipart/form-data">
                                                                                    <div class="form-group">
                                                                                        <input autocomplete="off"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">DELETE ARCHIVE
                                                                                    DOCUMENT</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-dismiss="modal">Close</button>
                                                                                <a type="button" class="btn btn-outline"
                                                                                    href="<?= base_url() ?>master/student_document/delete_file/<?= $student_document['id'] ?>/<?= $val['id'] ?>?type=student">Delete
                                                                                    Now</a>
                                                                            </div>
                                                                        </div>
                                                                        <!-- /.modal-content -->
                            ...
                            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" style="width:70px;">
                                                                ...
                                                                <a href="#!" class="btn btn-warning btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-update-result-test-<?= $i ?>"><i
                                                                        class="mdi mdi-pencil"></i></a>
                                                                <a href="#!" class="btn btn-danger btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-delete-result-test-<?= $i ?>"><i
                                                                        class="mdi mdi-delete"></i></a>
                                                                <?php
                                  if ($att[$val['id']]['file']) { ?>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">UPDATE RESULT
                                                                                    TEST</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                                <form
                                                                                    action="<?= base_url() ?>master/student_document/update_result_test/<?= $student_document['id'] ?>/<?= $val['id'] ?>"
                                                                                    method="POST"
                                                                                    enctype="multipart/form-data">
                                                                                    <div class="form-group">
                                                                                        <input autocomplete="off"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">DELETE RESULT
                                                                                    TEST</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                            ...
                            ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-left" style="width:70px;">
                                                                ...
                                                                <a href="#!" class="btn btn-warning btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-edit-checklist-<?= $i ?>"><i
                                                                        class="mdi mdi-pencil"></i></a>
                                                                <a href="#!" class="btn btn-danger btn-xs btn-delete"
                                                                    href="#!" data-toggle="modal"
                                                                    data-target="#modal-delete-checklist-<?= $i ?>"><i
                                                                        class="mdi mdi-delete"></i></a>
                                                                <?php
                                  if ($att[$val['id']]['file']) { ?>
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">UPDATE APPLICANT
                                                                                    CHECKLIST</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                                <form
                                                                                    action="<?= base_url() ?>master/student_document/update_checklist/<?= $student_document['id'] ?>/<?= $val['id'] ?>"
                                                                                    method="POST"
                                                                                    enctype="multipart/form-data">
                                                                                    <div class="form-group">
                                                                                        <input autocomplete="off"
                                                                        ...
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close"
                                                                                    ...
                                                                                    <span
                                                                                        aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title">DELETE APPLICANT
                                                                                    CHECKLIST</h4>
                                                                            </div>
                                                                            <div class="modal-body"
                                                                                style="color:#fff!important;">
                                                                            ...
                                                                            <div class="modal-footer">
                                                                                <button type="button"
                                                                                    ...
                                                                                    data-dismiss="modal">Close</button>
                                                                                <a type="button" class="btn btn-outline"
                                                                                    href="<?= base_url() ?>master/student_document/delete_checklist/<?= $student_document['id'] ?>/<?= $val['id'] ?>?type=student">Delete
                                                                                    Now</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
