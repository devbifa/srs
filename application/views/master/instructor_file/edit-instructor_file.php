  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/instructor_file/update') ?>" id="upload-create" enctype="multipart/form-data">

    <input type="hidden" name="id" value="<?= $instructor_file['id'] ?>">
        ...
        <div class="col-md-12">
          ...
          <div class="box">
            ...
            <div class="box-header-material box-header-material-text">
                <div class="row">
                <div class="col-xs-10">
                EDIT INSTRUCTOR ATTACHMENT TYPE
                </div>
                <div class="col-xs-2">
            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-3">
                      ...
                      <label for="form-instructor_file">ATTACHMENT NUMBER</label>

                      <input type="text" class="form-control" id="form-instructor_file" placeholder="Fill Attachment Number" name="dt[number]" value="<?= $instructor_file['number'] ?>">

                  </div>  <div class="form-group col-md-3">

<label for="form-instructor_file">ATTACHMENT NAME</label>

<input type="text" class="form-control" id="form-instructor_file" placeholder="Fill Attachment Name" name="dt[instructor_file]" value="<?= $instructor_file['instructor_file'] ?>">
           ...
           <div class="modal-dialog">
             <div class="modal-content">
               ...
               <div class="modal-body" style="color:#fff!important;">
                <form action="<?=base_url()?>master/instructor_file/delete/<?=$instructor_file['id']?>">
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('master/instructor_file') ?>";
