        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    ...
                    <div class="box-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select onchange="loadtable(this.value)" id="select-status" style="width: 150px"
                                    class="form-control">
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="">
                                <form autocomplete="off"
                                    action="<?= base_url() ?>master/daily_movement_report_approved/filter"
                                    method="post">
                                    <div class="col-md-2">
                        ...
                        ?>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>DEP</label>
                                            <input placeholder="DEP" type="text" class="form-control"
                                                class="form-control" value="<?= $_SESSION['keyword'] ?>" name="keyword"
                                                autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <label>ARR</label>
                                            <input placeholder="ARR" type="text" class="form-control"
                                                class="form-control" value="<?= $_SESSION['keyword_arr'] ?>"
                                                name="keyword_arr" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                  ...
                  $safety = $_GET['safety_code'];
                  $safety_type = $_GET['safety_type'];
                  if ($safety) {
                    $qry_irreg .= " AND remark_safety = '$safety' ";
                  }

                  if ($safety_type) {
                    $dat = $this->mymodel->selectWithQuery("SELECT * FROM safety_performance WHERE type = '$safety_type'");
                    $t = "'AANG',";
                    foreach ($dat as $k => $v) {
                      $t .= "'" . $v['code'] . "',";
                    }
                    $t = substr($t, 0, -1);
                    $qry_irreg .= " AND remark_safety IN ($t) ";
                  }
...
<div class="modal fade" id="modal-impor">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('fitur/impor/daily_movement_report') ?>" method="POST"
