...
<th rowspan="2" >TPM</th>
<th rowspan="2" >COURSE</th><th rowspan="2" >SUBJECT</th><th colspan="3">TIME PLAN (UTC)</th> <th rowspan="2" >REMARK</th><th colspan="3">TIME ACT (UTC)</th><th colspan="2" >PARTICIPANT</th> <th rowspan="2" >REMARK REPORT</th><th rowspan="2" >IRREG<br>CODE</th>
...
<td><?=$val['type']?></td>
  ...
  <td class="text-left"><?=$val['subject']?></td>
   <td><?=$val['start_lt']?></td> <td><?=$val['stop_lt']?></td><td><?=$val['duration']?></td> <td><?=$val['remark']?></td> 
   <td><?=$val['start_act']?></td> <td><?=$val['stop_act']?></td><td><?=$val['duration_act']?></td> 
   <td><?=$participant?></td> 
  <td><?=$attend?></td> 
  <td><?=$val['remark_2']?></td>  <td><?=$val['remark_report']?></td> <td><?=$sent?><br><?=$approval['prepared_time']?></td> 
</tr>
<?php } ?>
