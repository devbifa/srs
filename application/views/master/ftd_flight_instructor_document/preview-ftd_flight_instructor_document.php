            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-12">
                     ...
                     <label for="form-instructor_name">INSTRUCTOR NAME</label>
                      <br>
                      <?= $ftd_flight_instructor_document['instructor_name'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-nick_name">NICK NAME</label>
                      <br>
                      <?= $ftd_flight_instructor_document['nick_name'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-employee_number">EMPLOYEE NUMBER</label>
                      <br>
                      <?= $ftd_flight_instructor_document['employee_number'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-position">POSITION</label>
                      <br>
                      <?= $ftd_flight_instructor_document['position'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-license">LICENSE</label>
                      <br>
                      <?= $ftd_flight_instructor_document['license'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-course_capabilities">COURSE CAPABILITIES</label>
                      <br>
                      <?= $ftd_flight_instructor_document['course_capabilities'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-last_input_date">LAST INPUT DATE</label>
                      <br>
                      <?= $ftd_flight_instructor_document['last_input_date'] ?>
                  </div><div class="form-group col-md-12">
