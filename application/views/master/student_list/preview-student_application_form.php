<?php
$value = $student_application_form;
$title = 'APPLICANT REVIEW';
?>

<a href="<?=base_url()?>master/student_list/edit/<?=$student_application_form['id']?>" class="btn btn-primary  pull-right float-1" data-placement="top" title="EDIT STUDENT LIST"><i class="mdi mdi-pencil"></i></a>
...
if(in_array($_SESSION['role'],array('5'))){ 
  $pass_payment = '1';
  ?>
  <?php if(in_array($value['status'],array('PENDING','REJECT',''))){ ?>
    <a  class="btn btn-danger float-3" href="#!" data-toggle="modal" data-target="#modal-reject" data-placement="top" title="REJECT APPLICANT" ><i class="mdi mdi-close"></i></a>
    <a class="btn btn-success float-2" href="#!" data-toggle="modal" data-target="#modal-approve"  data-placement="top" title="PROPOSE TO FINANCE" ><i class="mdi mdi-checkbox-marked-circle-outline"></i></a>
    <a href="<?=base_url()?>master/student_list/edit/<?=$student_application_form['id']?>" class="btn btn-primary  pull-right float-1" data-placement="top" title="EDIT STUDENT STATUS"><i class="mdi mdi-pencil"></i></a>
  <?php }else if(in_array($value['status'],array('WAITING CONTRACT',''))){ ?>
   
             
              <a  class="btn btn-danger float-3" href="#!" data-toggle="modal" data-target="#modal-reject" data-placement="top" title="REJECT APPLICANT" ><i class="mdi mdi-close"></i></a>

              <a href="#!" data-toggle="modal" data-target="#modal-active" class="btn btn-success  pull-right float-2" data-placement="top" title="ACTIVATE STUDENT STATUS" ><i class="mdi mdi-checkbox-marked-circle-outline" ></i></a>
            
    <a href="<?=base_url()?>master/student_list/edit/<?=$student_application_form['id']?>" class="btn btn-primary  pull-right float-1" data-placement="top" title="EDIT STUDENT STATUS"><i class="mdi mdi-pencil"></i></a>
    <?php }else{ ?>
  
  <?php } ?>
<?php }else if(in_array($_SESSION['role'],array('6'))){
  $pass_payment = '1';
  ?>
  <?php if(in_array($value['status'],array('WAITING FINANCE'))){ ?>
    <a  class="btn btn-danger float-3" href="#!" data-toggle="modal" data-target="#modal-reject" data-placement="top" title="REJECT APPLICANT" ><i class="mdi mdi-close"></i></a>
    <a href="#!" data-toggle="modal" data-target="#modal-contract" class="btn btn-success  pull-right float-2" data-placement="top" title="PROPOSE TO CONTACT" ><i class="mdi mdi-checkbox-marked-circle-outline" ></i></a>
    <a href="<?=base_url()?>master/student_list/edit/<?=$student_application_form['id']?>" class="btn btn-primary  pull-right float-1" data-placement="top" title="EDIT STUDENT STATUS"><i class="mdi mdi-pencil"></i></a>
    <?php }else{ ?>
...
<input disabled type="hidden" name="id" value="<?= $student_application_form['id'] ?>">
      ...
      <div class="box-header-material box-header-material-text">
            <div class="row">
            <div class="col-xs-10">
            REVIEW APPLICANT STATUS : <?=$student_application_form['status']?>
            </div>
            <div class="col-xs-2">
                <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
...
<div class="form-group col-md-12">
              ...
              <div class="form-group col-md-6">
                  ...
                  <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert ID Number" name="dt[id_number]" value="<?= $student_application_form['id_number'] ?>">
...
<input disabled autocomplete="off" style='width:100%' name="password" class="form-control" placeholder="Leave blank if you do not wish to change the password">
          ...
          <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-6">
                  ...
                  <input disabled type="text" class="form-control" id="form-full_name" placeholder="Insert Nick Name" name="dt[nick_name]" value="<?= $student_application_form['nick_name'] ?>">
                   ...
                   var str = response;
                    ...
                    if (str.indexOf("success") != -1){
                        ...
                        setTimeout(function(){ 
                           ...
                           window.location.href = "<?= base_url('master/student_application_form/preview/'.$student_application_form['id']) ?>";
