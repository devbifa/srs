  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/master_curriculum/store') ?>" id="upload-create" enctype="multipart/form-data">
  ...
  <div class="row">
                <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control" id="form-curriculum_code" placeholder="Masukan Curriculum Code" name="dt[curriculum_code]">

                  </div><div class="form-group col-md-12">

                      <label for="form-curriculum_name">CURRICULUM NAME</label>

                      <input type="text" class="form-control" id="form-curriculum_name" placeholder="Masukan Curriculum Name" name="dt[curriculum_name]">
