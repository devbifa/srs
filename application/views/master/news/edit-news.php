      ...
      <a href="" class="btn btn-danger float-2" href="#!" data-toggle="modal" data-target="#modal-delete-1" data-placement="top" title="DELETE NEWS" ><i class="mdi mdi-delete"></i></a>
           ...
           <div class="modal-dialog">
             <div class="modal-content">
               ...
               <div class="modal-body" style="color:#fff!important;">
                <form action="<?=base_url()?>master/news/delete/<?=$news['id']?>">
  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/news/update') ?>" id="upload-create" enctype="multipart/form-data">
