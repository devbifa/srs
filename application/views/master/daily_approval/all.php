      ...
      <div class="row">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="row">
                            <div class="">
                                <form autocomplete="off" action="<?= base_url() ?>master/daily_approval/filter" method="post">
                                <div class="col-md-2">
...
<td style="min-width:50px;">
  ...
  <a href="<?=base_url()?>master/daily_approval/edit/<?=$val['id']?>" class="btn btn-primary btn-xs btn-rounded"><i class="mdi mdi-pencil"></i></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/approve/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
...
<div class="modal modal-success fade" id="modal-approve2-<?=$val['id']?>-FLIGHT">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="color:#fff!important;">
        <form action="<?=base_url()?>master/daily_approval/approve_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
        <div class="form-group">
        <p>Are you sure to approve this schedule?</p>
...
<div class="modal modal-warning fade" id="modal-rollback-<?=$val['id']?>-FLIGHT">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/rollback/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
        ...
        <div class="modal modal-warning fade" id="modal-rollback2-<?=$val['id']?>-FLIGHT">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/rollback_2/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                <p>Are you sure to rollback this schedule?</p>
...
$start_date = $_SESSION['start_date'];
      ...
      $my_id = $_SESSION['id'];
			...
			$data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'FLIGHT REPORT'  ".$origin_base." ORDER BY date DESC");
      foreach($data as $key=>$val){
        $id_approved_by = $val['approved_by'];
        $id_approved_by_2 = $val['approved_by_2'];
...
<td style="min-width:50px;">
  ...
  <?php if($id_approved_by){  ?>
  <?php if($val['approval_status']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve-<?=$val['id']?>-FLIGHT"  data-placement="top" title="APPROVE REPORT" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback-<?=$val['id']?>-FLIGHT"  data-placement="top" title="ROLLBACK REPORT" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
  <?php if($id_approved_by_2){ ?>
  <?php if($val['approval_status_2']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve2-<?=$val['id']?>-FLIGHT"  data-placement="top" title="APPROVE REPORT 2" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status_2']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback2-<?=$val['id']?>-FLIGHT"  data-placement="top" title="ROLLBACK REPORT 2" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">APPROVE DAILY FLIGHT REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/approve_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                <p>Are you sure to approve this REPORT?</p>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-outline">Approve Report</button>
                </form>
              </div>
            </div>
            <!-- /.modal-content -->
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">ROLLBACK DAILY FLIGHT REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/rollback_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                <p>Are you sure to rollback this REPORT?</p>
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <button type="submit" class="btn btn-outline">Rollback Report</button>
                </form>
              </div>
            </div>
            <!-- /.modal-content -->
...
$start_date = $_SESSION['start_date'];
      ...
      $my_id = $_SESSION['id'];
			...
			$data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'FTD REPORT'  ".$origin_base." ORDER BY date DESC");
    //  echo "SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'FTD'  ".$origin_base." ORDER BY date DESC";
      $nomor = 0;
      foreach($data as $key=>$val){
        $id_approved_by = $val['approved_by'];
...
<td style="min-width:50px;">
  ...
  <?php if($id_approved_by){  ?>    
  <?php if($val['approval_status']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve-<?=$val['id']?>-FTD"  data-placement="top" title="APPROVE REPORT" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback-<?=$val['id']?>-FTD"  data-placement="top" title="ROLLBACK REPORT" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
  <?php if($id_approved_by_2){ ?>
  <?php if($val['approval_status_2']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve2-<?=$val['id']?>-FTD"  data-placement="top" title="APPROVE REPORT 2" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status_2']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback2-<?=$val['id']?>-FTD"  data-placement="top" title="ROLLBACK REPORT 2" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">APPROVE DAILY FTD REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/approve_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">ROLLBACK DAILY FTD REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/rollback_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
...
$start_date = $_SESSION['start_date'];
      ...
      $my_id = $_SESSION['id'];
			...
			$data =  $this->mymodel->selectWithQuery("SELECT * FROM approval WHERE DATE(date) >= '$start_date' AND DATE(date) <= '$end_date' AND type = 'GROUND REPORT'  ".$origin_base." ORDER BY date DESC");
      $nomor = 0;
      foreach($data as $key=>$val){
        $id_approved_by = $val['approved_by'];
        $id_approved_by_2 = $val['approved_by_2'];
...
<td style="min-width:50px;">
  ...
  <?php if($val['approval_status']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve-<?=$val['id']?>-GROUND"  data-placement="top" title="APPROVE REPORT" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback-<?=$val['id']?>-GROUND"  data-placement="top" title="ROLLBACK REPORT" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
  <?php if($id_approved_by_2){ ?>
  <?php if($val['approval_status_2']!='APPROVED'){ ?>
  <a class="btn btn-success btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-approve2-<?=$val['id']?>-GROUND"  data-placement="top" title="APPROVE REPORT 2" ><i class="mdi mdi-check"></i></a>
  <?php }else if($val['approval_status_2']=='APPROVED'){ ?>
  <a class="btn btn-warning btn-rounded btn-xs" href="#!" data-toggle="modal" data-target="#modal-rollback2-<?=$val['id']?>-GROUND"  data-placement="top" title="ROLLBACK REPORT 2" ><i class="mdi mdi-reload"></i></a>
  <?php } ?>
  <?php } ?>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">APPROVE DAILY GROUND REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/approve_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">ROLLBACK DAILY GROUND REPORT</h4>
              </div>
              <div class="modal-body" style="color:#fff!important;">
               <form action="<?=base_url()?>master/daily_approval/rollback_report/<?=$val['id']?>" method="POST" enctype="multipart/form-data">
                <div class="form-group">
