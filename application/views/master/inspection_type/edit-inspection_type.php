...
<div class="form-group col-md-12">
  ...
  ?>
     ...
     <td>
      <input required type="number" class="form-control" id="project<?=$no?>" name="konfigurasi[<?=$key?>][hours]" value="<?=$val['hours']?>">
    </td>
     <td>
...
var jum = <?=intval($key)+1?>;

function tambahBaris() {
  var html = '<tr id="'+jum+'">'+
            '    <td></td>'+
           '        <td>'+
                    '<input required type="text" class="form-control " id="project'+jum+'" name="konfigurasi['+jum+'][option]">'+
                    ' </td>'+
           '        <td>'+
                    '<input required type="number" class="form-control " id="projects'+jum+'" name="konfigurasi['+jum+'][hours]">'+
                    ' </td>'+
           '        <td>'+
                    '<input required type="text" class="form-control " id="projects'+jum+'" name="konfigurasi['+jum+'][due]">'+
                    ' </td>'+
