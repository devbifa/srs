  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/master_course/store') ?>" id="upload-create" enctype="multipart/form-data">
  ...
  <div class="row">
                <div class="form-group col-md-12">
                      ...
                      <input type="text" class="form-control" id="form-course_code" placeholder="Masukan Course Code" name="dt[course_code]">

                  </div><div class="form-group col-md-12">

                      <label for="form-course_name">COURSE NAME</label>

                      <input type="text" class="form-control" id="form-course_name" placeholder="Masukan Course Name" name="dt[course_name]">
