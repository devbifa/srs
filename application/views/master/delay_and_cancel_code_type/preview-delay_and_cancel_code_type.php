          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  ...
                  Edit Delay And Cancel Code Type
  ...
  <div class="form-group col-md-6">
                     <label for="form-delay_and_cancel_code_type">DELAY AND CANCEL CODE TYPE</label>
  </div>
  <div class="form-group col-md-6">
                      : <?= $delay_and_cancel_code_type['delay_and_cancel_code_type'] ?>
                  </div>
                  </div>
                      </div>
