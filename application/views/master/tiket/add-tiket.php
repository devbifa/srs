    ...
    <form method="POST" action="<?= base_url('master/Tiket/store') ?>" id="upload-create" enctype="multipart/form-data">

                <div class="show_error"></div><div class="form-group">

                      <label for="form-kronologis">Kronologis</label>

                      <textarea name="dt[kronologis]" class="form-control"></textarea>

                  </div><div class="form-group">

                      <label for="form-fitur">Fitur</label>

                      <input type="text" class="form-control" id="form-fitur" placeholder="Masukan Fitur" name="dt[fitur]">
                      ...
                      <input type="text" class="form-control" id="form-username" placeholder="Masukan Username" name="dt[username]">
