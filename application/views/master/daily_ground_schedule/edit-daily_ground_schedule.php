...
<div class="content-wrapper">
    ...
    <section class="content">
        ...
        <form method="POST" action="<?= base_url('master/daily_ground_schedule/update') ?>" id="upload-create"
                              ...
                              foreach ($student_list_other as $key => $val) {
                                ...
                                if ($val['check'] == 'on') {
                                  ...
                                  foreach ($batch_datas as $key2 => $val2) {
                                    ...
                                    $text2 .= "<option " . $text . " value='" . $val2['code'] . "' " . $text . " >" . $val2['batch'] . ' (' . $val2['curriculum'] . ")</option>";
                                  }
                                  ...
                                  foreach ($student_list as $key2 => $val2) {
                                    // echo $val['id_number'];
                                    $text = "";
                                    if ($val['val'] == $val2['id_number']) {
                                      $text = "selected";
                                    }
                                    $student_text .= "<option " . $text . " value='" . $val2['id_number'] . "' " . $text . " >" . $val2['id_number'] . ' - ' . $val2['full_name'] . "</option>";
                                  }
                                  ...
                                  $table_body .= '<tr id="' . $i . '">
                                    ...
                                    <td colspan="3">
                                    <select required style="width:100%" name="dttt[' . $i . '][val]" class="select2 id_number" id="id_number' . $i . '">
                                        ' . $student_text . '
                                      </select>
                                  </td>
                                  <td>
            ...
            if (str.indexOf("success") != -1) {
                ...
                setTimeout(function() {
                    ...
                    window.location.href =
                        "<?= base_url('master/daily_ground_schedule/create') ?>";
                    <?php } else { ?>
                    window.location.href =
                        "<?= base_url('master/daily_ground_schedule/create') ?>";
                    <?php } ?>
