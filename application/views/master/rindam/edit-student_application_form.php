            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-6">
                  ...
                  <div class="form-group col-md-6">
                      ...
                      <input type="text" class="form-control" id="form-full_name" placeholder="Insert Nick Name" name="dt[nick_name]" value="<?= $student_application_form['full_name'] ?>">
...
?>
<tr>
<td style="width:10px;"><input type="checkbox" checked ></td>
<td class="text-left">
<?=$val['course']?>
...
<input  name="dtt[<?=$no?>][ftd]" type="text" style="width:75px;" placeholder="HH:mm" value="<?=$training_requirement[$no]['ftd']?>">
    ...
    <!-- <input type="text" class="form-control" id="form-training_requirement" placeholder="Insert Training Requirement" name="dt[training_requirement]" value="<?= $student_document['training_requirement'] ?>"> -->
