 ...
 <!-- Content Wrapper. Contains page content -->
            ...
            <div class="box-header">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="pull-right">          <a href="<?= base_url('master/motor/create') ?>">
                  ...
                  <a href="<?= base_url('fitur/ekspor/motor') ?>" target="_blank">
  ...
  <div class="modal fade bd-example-modal-sm" tabindex="-1" motor="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true" id="modal-delete">
  ...
  <div class="modal fade" id="modal-impor">
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <form action="<?= base_url('fitur/impor/motor') ?>" method="POST"  enctype="multipart/form-data">
  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">No</th>'+'<th>Nama Motor</th>'+'<th>Deskripsi Motor</th>'+'       <th style="width:150px">Status</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                columns: [
                    ...
                    {"data": "id","orderable": false},{"data": "nama_motor"},{"data": "deskripsi_motor"},
