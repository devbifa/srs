            ...
            <div class="box-body">
                ...
                <div class="form-group col-md-12">
                     ...
                     <label for="form-date">DATE</label>
                      ...
                      <br>
                      <?= $daily_fuel_consumption['date'] ?>
                  </div><div class="form-group col-md-12">

                     <label for="form-acft_reg">ACFT REG</label>

                      <br>
                      <?= $daily_fuel_consumption['acft_reg'] ?>
