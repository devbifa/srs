  ...
  <script type="text/javascript">
        ...
        function loadtable(status) {
            ...
            var table = '<table class="table table-bordered" id="mytable">'+
                   ...
                   '       <th style="width:20px">NUM</th>'+'<th>TYPE</th>'+'<th>MODEL</th>'+'<th>SERIAL NUMBER</th>'+'<th>CODE</th>'+'<th>CERTIFICATE NUMBER</th>'+'<th>VALID FROM</th>'+'<th>VALID UNTIL</th>'+'<th>CAPABILITY</th>'+
             ...
             $("#load-table").html(table)
              ...
              var t = $("#mytable").dataTable({
                ...
                columns: [
                    ...
                    {"data": "id","orderable": false},{"data": "type"},{"data": "model"},{"data": "serial_number"},{"data": "code"},{"data": "certificate_number"},{"data": "certificate_valid"},{"data": "certificate_valid_until"},{"data": "type_enginee"},
