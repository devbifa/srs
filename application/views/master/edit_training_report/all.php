...
<th style="width:20px" rowspan="2">NUM</th><th rowspan="2" style="min-width:130px;">ACTION</th>
...
$nomor = 0;
$data_date =  $this->template->date_range($_SESSION['start_date'], $_SESSION['end_date']);
...
<td><?=$val['type']?></td>
  ...
  <td class="text-left"><?=$val['subject']?></td>
   ...
   <td><?=$participant?></td> 
  <td><?=$attend?></td> 
  <td><?=$val['remark_2']?></td>  <td><?=$val['remark_report']?></td> 
</tr>
<?php } ?>
...
<th rowspan="2" style="min-width:130px;">ACTION</th>
<th style="min-width:110px"  rowspan="2">DATE</th>
...
<?php }else{ ?>
  ...
  <div class="modal modal-danger fade" id="ftd-delete-<?=$val['id']?>">
        ...
        <a href="#!" data-toggle="modal" data-target="#approve-ftd-<?=$val['id']?>" class="btn btn-warning btn-xs btn-rounded"><i class="mdi mdi-arrow-right"></i></a>

            
<div class="modal modal-warning fade" id="approve-ftd-<?=$val['id']?>">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title">GENERATE APPROVAL</h4>
            </div>
            <div class="modal-body" style="color:#fff!important;">
            <form action="">
              <span style="font-weight:100">Are you sure you want to generate approval this report?</span>
            </form>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
              <a type="button" class="btn btn-outline" href="<?=base_url()?>fitur/generate_daily_approval/ftd/<?=$val['date']?>">Generate Approval Now</a>
            </div>
          </div>
        </div>
      </div>
...
<div class="modal modal-warning fade" id="flight-revise-<?=$val['id']?>">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                <a type="button" class="btn btn-outline" href="<?=base_url()?>master/daily_movement_report/edit/<?=$val['id']?>">Revise Now</a>
              </div>
            </div>
          </div>
        </div>
...
<?php }else{ ?>
  ...
  <div class="modal modal-danger fade" id="ftd-flight-<?=$val['id']?>">
        ...
        <a href="#!" data-toggle="modal" data-target="#approve-flight-<?=$val['id']?>" class="btn btn-warning btn-xs btn-rounded"><i class="mdi mdi-arrow-right"></i></a>

            
      <div class="modal modal-warning fade" id="approve-flight-<?=$val['id']?>">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                    <a type="button" class="btn btn-outline" href="<?=base_url()?>fitur/generate_daily_approval/flight/<?=$val['date_of_flight']?>">Generate Approval Now</a>
                  </div>
                </div>
              </div>
            </div>
