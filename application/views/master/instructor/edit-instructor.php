...
<div class="form-group col-md-12">
                      ...
                      <label for="form-employee_number">PASSWORD</label>

                      <input type="text" class="form-control" id="form-employee_number" placeholder="Masukan Password" name="password">
