  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/maintenance_aircraft_engine/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-header">
              ...
              <h5 class="box-title">
                  ...
                  Tambah Maintenance Aircraft Engine
                ...
                <div class="form-group col-md-12">
                      ...
                      <select style='width:100%' name="dt[aircraft_reg]" class="form-control select2">
                        ...
                        foreach ($aircraft_document as $aircraft_document_record) {
                          ...
                          echo "<option value='".$aircraft_document_record['id']."' >".$aircraft_document_record['serial_number']."</option>";
                      ...
                      <input type="text" class="form-control" id="form-new_serial_number" placeholder="Masukan New Serial Number" name="dt[new_serial_number]">

                  </div><div class="form-group col-md-12">

                      <label for="form-old_serial_number">OLD SERIAL NUMBER</label>

                      <input type="text" class="form-control" id="form-old_serial_number" placeholder="Masukan Old Serial Number" name="dt[old_serial_number]">
