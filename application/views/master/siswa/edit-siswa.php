  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Siswa/update') ?>" id="upload-create" enctype="multipart/form-data">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <select style='width:100%' name="dt[batch]" class="form-control select2">
                        ...
                        foreach ($batch as $batch_record) {
                          ...
                          if($batch_record['id']==$siswa['batch']){
                          ...
                          echo "<option value=".$batch_record['id']." ".$text." >".$batch_record['nama_batch']."</option>";
                      ...
                      <input type="text" class="form-control" id="form-nama_lengkap" placeholder="Masukan Nama Lengkap" name="dt[nama_lengkap]" value="<?= $siswa['nama_lengkap'] ?>">

                  </div><div class="form-group">

                      <label for="form-deskripsi">Deskripsi</label>

                      <textarea name="dt[deskripsi]" class="form-control"><?= $siswa['deskripsi'] ?></textarea>
