  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="<?= base_url('master/Team/store') ?>" id="upload-create" enctype="multipart/form-data">
          ...
          <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="show_error"></div><div class="form-group">
                      ...
                      <input type="text" class="form-control" id="form-nama_team" placeholder="Masukan Nama Team" name="dt[nama_team]">
