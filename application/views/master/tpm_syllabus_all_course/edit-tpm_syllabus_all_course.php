...
<input type="text" class="form-control" id="form-duration_instruct" placeholder="Masukan Duration Solo (SVP)" name="dt[duration_pic_solo]" value="<?=$tpm_syllabus_all_course['duration_pic_solo']?>">

</div>
<div class="form-group col-md-3">

<label for="form-duration_instruct">DURATION NON REV</label>

<input type="text" class="form-control" id="form-duration_instruct" placeholder="Masukan Duration Non Rev" name="dt[duration_non_rev]" value="<?=$tpm_syllabus_all_course['duration_non_rev']?>">
...
<input type="text" class="form-control" id="form-duration_instruct" placeholder="Masukan Type Of Training Type" name="dt[type_of_training_type2]" value="<?=$tpm_syllabus_all_course['type_of_training_type2']?>">
         ...
         <div class="form-group col-md-3">
                  ...
                  if($tpm_syllabus_all_course['file']!=""){ ?>
                    <a href="<?= base_url() ?>webfile/tpm/<?=$tpm_syllabus_all_course['file']?>" target="_blank"><i class="fa fa-download"></i> <?= $tpm_syllabus_all_course['file'] ?></a>
